      ...
      <Tabs defaultValue="analytics" className="space-y-6">
        ...
        <TabsContent value="analytics">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <Card>
              <CardHeader>
                <CardTitle>{t("table.analytics.user_analytics")}</CardTitle>
              </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                {analyticsSummary?.topSearchTerms &&
                    ...
                    {analyticsSummary.topSearchTerms
                      ...
                      .map((term, index) => (
                        ...
                        >
                          ...
                          <Badge variant="secondary">x {term.count}</Badge>
                        </div>
                      ))}
                  </div>
                ) : (
                  <p className="text-muted-foreground text-center py-4">
                    {t("table.analytics.no_search_terms")}
                  </p>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                {analyticsSummary?.topViewedServices &&
                analyticsSummary.topViewedServices.length > 0 ? (
                  <div className="space-y-3">
                    {analyticsSummary.topViewedServices
                      .slice(0, 5)
                      .map((service, index) => (
                        ...
                        >
                          ...
                          <Badge variant="secondary">
                            {service.views} <Eye size={14} className="ml-2" />
                          </Badge>
                        </div>
                      ))}
                  </div>
          ...
          <Suspense
            fallback={
              <div className="w-full flex items-center justify-center min-h-72">
                <Users className="size-32 animate-pulse text-primary" />
              </div>
            }
          >
            <ErrorBoundary
            ...
            >
              <UserManagement count={stats.totalUsers} />
            </ErrorBoundary>
          </Suspense>
        </TabsContent>
        ...
        <TabsContent value="services">
          <Suspense
            fallback={
              <div className="w-full flex items-center justify-center min-h-72">
                <Settings className="size-32 animate-pulse text-primary" />
              </div>
            }
          >
            <ErrorBoundary
            ...
            >
              <ServiceManagement count={stats.publishedServices} />
            </ErrorBoundary>
          </Suspense>
        </TabsContent>
        ...
        <TabsContent value="pending-services">
          ...
          >
            ...
            >
              <PendingServicesManagement count={stats.pendingServicesCount} />
            </ErrorBoundary>
          </Suspense>
        </TabsContent>
          ...
          <Suspense
            fallback={
              <div className="w-full min-h-72 flex items-center justify-center">
                <BadgePercent className="size-32 animate-pulse text-primary" />
              </div>
            }
          >
            <ErrorBoundary
              fallback={
                <div className="w-full flex items-center justify-center">
                  <BadgePercent className="size-30 animate-pulse text-primary" />
                </div>
              }
            >
              <CouponsManagement count={stats.couponsCount} />
            </ErrorBoundary>
          </Suspense>
        </TabsContent>
      </Tabs>
